	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				up = glm::cross(right, forward);	// Facem ortogonali
				// TODO
			...
			{
				up = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(up, 0);
				up = glm::normalize(up);

				forward = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(forward, 0);
				forward = glm::normalize(forward);
			...
			void RotateThirdPerson_OX(float angle)
			{
				...
				// Use distanceToTarget as translation
